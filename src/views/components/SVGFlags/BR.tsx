...
export function BR(props:{size:number}){
  const ratio = 640/480

  return <svg width={props.size*ratio} height={props.size} xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-br" viewBox="0 0 640 480">
  <g stroke-width="1pt">
